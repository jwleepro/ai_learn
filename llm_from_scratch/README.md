...
용어가 헷갈리면 먼저 `GLOSSARY.md`를 한 번만 훑고 오면 훨씬 빨라집니다.

## 시작 순서

1. `CURRICULUM.md` : 전체 로드맵(주차별 목표/산출물)
2. `GLOSSARY.md` : 용어/shape(배열 크기) 빠른 정리
3. `lessons/00_setup.md` : 실습 환경 준비
4. `lessons/00_dl_basics.md` : (Week 0) 딥러닝 기초를 코드로
